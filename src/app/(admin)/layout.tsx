...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 transform transition-transform lg:translate-x-0 lg:static',
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-2 px-6 h-16 border-b border-gray-700">
            ...
            <span className="ml-auto px-2 py-0.5 bg-primary rounded text-xs text-white font-medium">Admin</span>
          </div>
          ...
          <div className="px-4 py-4 border-t border-gray-700">
            <div className="flex items-center gap-3 px-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-label text-white truncate">{userName}</p>
                <p className="text-body-sm text-gray-400 truncate">System Admin</p>
              </div>
              <button
